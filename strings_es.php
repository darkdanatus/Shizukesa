...
define(S_FOOT, '- <a href="http://www.2chan.net/" target="_blank">futaba</a> + <a href="http://1chan.net/futallaby/" target="_blank">futallaby</a> + <a href="http://saguaroimgboard.co.cc/" target="_blank">saguaro 0.97.8</a> -'); //Prints footer (leave these credits)
