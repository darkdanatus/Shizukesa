...
define(S_PROXY80, 'Error: Proxy detected on port 80.');							//Returns error for proxy detection on port 80
define(S_PROXY8080, 'Error: Proxy detected on port 8080.');							//Returns error for proxy detection on port 8080
